...
## AIM
### My aim is to make code for other people avalible to everyone, this is the backend of the site and the frontend will be designed with the help of a few friends

## How to use
### Step 1:
go to `iz4c810.github.io` as thats the webpage listed

### Step 2
play around, if you need to restart it, reload the webpage
